...
static const struct test_case_moventries TESTS[] = {
	...
	/* TODO CSTAT FAILS AND OUTPUTS INVALID TELEGRAM TO OUT_TELEGRAM_2 (ALL ONES VALUES ARE > 9)
	        ALREADY THE FIRST LINE'S MEMORY CONTENTS ARE INVALID! WHY ARE THEY NOT VALIDATED? */
	{
		/*
		...
		.out_telegram_1_len = 60,
		.out_telegram_2_len = 60,
		.out_telegram_1 = { 0x56,0x55,0x55,0x55,0xd7,0xaf,0xa6,0x69,0x65,0x5a,0x56,0x95,0x6b,0x56,0x5a, },
		.out_telegram_2 = { 0x56,0x55,0x55,0x55,0x57,0x57,0xa5,0x69,0xe5,0xef,0xea,0xbe,0xeb,0xfe,0x7a, },
	},
	{
		/*
